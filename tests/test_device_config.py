...
class TestDeviceConfigurationService:
    ...
    @patch(
        "builtins.open",
        mock_open(
            read_data='{"120_12345": {"device_id": 12345, "device_type": 120, "device_name": "HR Monitor"}}'
        ),
    )
    ...
    def test_configure_devices_no_devices_file(self, mock_input, mock_open):
        ...
        config = {
            ...
            "devices": {"heart_rate": {"enabled": False, "device_id": None}},
        }
    ...
    @patch(
        "builtins.open",
        mock_open(
            read_data='{"120_12345": {"device_id": 12345, "device_type": 120, '
            '"device_name": "HR Monitor"}, "121_67890": {"device_id": 67890, '
            '"device_type": 121, "device_name": "Bike Sensor"}}'
        ),
    )
    @patch("builtins.input")
